...
class SimulationGUI(QWidget):
    ...
    def addFieldWithExplanation(self, label_text, widget, max_value=None, decimals=None, step=None, default_value=None, explanation=None):
        label = QLabel(label_text, self)
        explanation_label = QLabel(self)
        explanation_pixmap = QPixmap(self.icon_file)
        explanation_pixmap = explanation_pixmap.scaled(20, 20, Qt.KeepAspectRatio, Qt.SmoothTransformation)
    ...
    def loadParams(self):
        ...
        if os.path.exists(self.params_file):
            with open(self.params_file, "r") as file:
                ...
                self.baseSmearPercentInput.setValue(params.get("baseSmearPercent", 0.168))
    ...
    def runSimulation(self):
        ...
        script = (
            "pion_simulation_script"
            if particleType == "pion"
            else "eta_simulation_script"
        )
        ...
        params = {
            ...
            "PT Max": self.ptMaxInput.value(),
            "PT Min": self.ptMinInput.value(),
            ...
            "PT1 Cut": self.pt1cutInput.value(),
            "PT2 Cut": self.pt2cutInput.value(),
            "Combined PT Cut": self.combPtCutInput.value(),
            "PT Max Cut": self.ptMaxCutInput.value(),
            "NCLUS PT Cut": self.nclusPtCutInput.value(),
            "Position Smearing Factor": self.positSmearingFactorInput.value(),
