...
class SimulationGUI(QWidget):
    ...
    def initUI(self):
        ...
        self.asymmCutInput = self.addFieldWithExplanation(
            ...
            QCheckBox(self),
            default_value=True,
            explanation="Check to apply asymmetry cut.",
        )
        ...
        self.clusterOverlapProbInput = self.addFieldWithExplanation(
            "(NO) Cluster Overlap Probability:",
            QDoubleSpinBox(self),
            max_value=1,
            decimals=3,
            step=0.001,
        ...
        self.combPtCutInput = self.addFieldWithExplanation(
            "Combined PT Cut factor:",
            QDoubleSpinBox(self),
            max_value=100,
            decimals=2,
            default_value=0,
            explanation="Enter the combined PT cut factor. Note it is implemented as Particle_pt > combPtCut * (pt1cut + pt2cut). 0 means NO cut.",
        )
        ...
        self.nclusPtCutInput = self.addFieldWithExplanation(
            ...
            decimals=2,
            default_value=0.0,
            explanation="Enter the NCLUS PT cut value in GeV. photon pt must be greater than this value. Often redundant with ptcuts.",
        )
    ...
    def runSimulation(self):
        ...
        elif outputFormat == "png" or outputFormat == "jpeg":
